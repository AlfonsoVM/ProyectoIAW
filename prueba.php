...
session_start();
	if (isset($_REQUEST["error"])) {
    	print "<p style='color: red'> $_REQUEST[errorI] </p>";
	}
	if (isset($_REQUEST["correctoC"])) {
		print "<p style='color: green'> $_REQUEST[correctoC] </p>";
	}
	if (isset($_REQUEST["cerrar"])) {
		print "<p style='color: black'> $_REQUEST[cerrar] </p>";
	}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <a class="navbar-brand font-weight-bolder mr-3" href="prueba.php"><img src="assets/img/logo.png"></a>
