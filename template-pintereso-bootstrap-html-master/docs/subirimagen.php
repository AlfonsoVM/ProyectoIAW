...
<table class="tg">
  ...
  <tr>
    <td class="tg-06e6">Título</td>
    <td class="tg-0lax"><input type="text" name="titulo" id="titulo" placeholder="Ponga un título"></td>
  </tr>
  <tr>
    <td class="tg-06e6">Imagen</td>
    <td class="tg-0lax"><input type="file" name="imagen" id="imagen" placeholder="Seleccione una imagen"></td>
  </tr>
  
  
</table><br>
<input type="submit" class="boton" value="Subir"> 
